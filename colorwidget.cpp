...
ColorWidget::ColorWidget(QWidget *parent) : QWidget(parent)
{
    ...
    QRect * paletteSize = new QRect(QPoint(100,200), QSize(11,16));
    layout->setGeometry(paletteSize);
...
void ColorWidget::populateColors()
{
...
void ColorWidget::setButtonColor(DoubleclickButton *button, QColor color)
{
    button->setStyleSheet(QString("background-color: %1")
                          .arg(color.name()));
}

void ColorWidget::makeConnections(DoubleclickButton *button, int index)
{
